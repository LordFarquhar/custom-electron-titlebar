...
exports.convertAccelerator = void 0;

const platform_1 = require("./vs/base/common/platform");

const convertAccelerator = electronAccelerator => {
  let vsAccelerator;
...
exports.convertAccelerator = _get__("convertAccelerator");
...
function _get_original__(variableName) {
  switch (variableName) {
    ...
    case "convertAccelerator":
      return convertAccelerator;
  }
