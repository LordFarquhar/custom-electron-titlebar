...
exports.BrowserFeatures = {
  clipboard: {
    writeText: _get__("platform").isNative || document.queryCommandSupported && document.queryCommandSupported('copy') || !!(navigator && navigator.clipboard && navigator.clipboard.writeText),
    readText: _get__("platform").isNative || !!(navigator && navigator.clipboard && navigator.clipboard.readText),
    richText: (() => {
      if (_get__("browser").isEdge) {
  ...
  keyboard: (() => {
    if (_get__("platform").isNative || _get__("browser").isStandalone) {
      return 0
      /* Always */
      ;
    }

    if (navigator.keyboard || _get__("browser").isSafari) {
      return 1
      /* FullScreen */
      ;
    }
