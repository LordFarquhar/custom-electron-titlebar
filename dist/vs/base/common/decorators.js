...
exports.createDecorator = _get__("createDecorator");
let memoizeId = 0;

function createMemoizer() {
  const memoizeKeyPrefix = `$memoize${_update_operation__("++", "memoizeId", false)}`;
  let self = undefined;
...
exports.createMemoizer = _get__("createMemoizer");

function memoize(target, key, descriptor) {
  return _get__("createMemoizer")()(target, key, descriptor);
}
